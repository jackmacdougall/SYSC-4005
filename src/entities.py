...
initialize_time_alternate = 100.0
...
def initializeCheck(self):
    ...
    return ((not sim.isProductionRun()) or system.env.now > initialize_time or (sim.isAlternative() and system.env.now > initialize_time_alternative))
